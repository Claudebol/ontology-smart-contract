...
var Provider = require("ontsc-provider");
var OntscError = require("ontsc-error");
var Module = require('module');
var findUp = require("find-up");
var originalrequire = require("original-require");

var DEFAULT_CONFIG_FILENAME = "ontsc.js";
var BACKUP_CONFIG_FILENAME = "ontsc-config.js"; // For Windows + Command Prompt

function Config(ontsc_directory, working_directory, network) {
  var self = this;
  ...
  this._values = {
    ontsc_directory: ontsc_directory || path.resolve(path.join(__dirname, "../")),
    ...
    ethpm: {
      ...
      install_provider_uri: "https://ropsten.infura.io/ontsc"
    },
    solc: {
      optimizer: {
        enabled: false,
  ...
  var props = {
    ...
    example_project_directory: function() {
      return path.join(self.ontsc_directory, "example");
    },
    network_id: {
      get: function() {
        try {
...
Config.detect = function(options, filename) {
  ...
  if (file == null) {
    throw new OntscError("Could not find suitable configuration file.");
  }
