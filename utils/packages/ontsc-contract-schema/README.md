# Schema Description: Ontsc Contract Object
...
[ontsc-contract](https://github.com/claudebol/ontsc-contract) uses a
...
(such as ontsc-contract) by capturing relevant smart contract information in a
