...
Ontsc is a development environment, testing framework and asset pipeline for Ethereum, aiming to make life as an Ethereum developer easier. With Ontsc, you get:
...
* External script runner that executes scripts within a Ontsc environment.
