var command = {
  ...
  run: function (options, done) {
    ...
    var Debugger = require("ontsc-debugger");
    var DebugUtils = require("ontsc-debug-utils");
    var Environment = require("../environment");
    var ReplManager = require("../repl");
    var selectors = require("ontsc-debugger").selectors;
    ...
    Environment.detect(config, function(err) {
      ...
      if (config._.length == 0) {
        return callback(new Error(
          ...
          "debug that transaction. i.e., ontsc debug 0x1234..."
        ));
      }
