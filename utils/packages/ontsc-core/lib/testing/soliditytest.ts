...
var Deployer = require("ontsc-deployer");
var find_contracts = require("ontsc-contract-sources");
var compile = require("ontsc-compile");
var artifactor = require("ontsc-artifactor");
...
var SolidityTest = {
  ...
  deployTestDependencies: function(abstraction, dependency_paths, runner, callback) {
    ...
    var Assert = runner.config.resolver.require("ontsc/Assert.sol");
    var DeployedAddresses = runner.config.resolver.require("ontsc/DeployedAddresses.sol");
