...
var Migrate = require("ontsc-migrate");
var Contracts = require("ontsc-workflow-compile");
var Networks = require("../lib/networks");
var path = require("path");
var fs = require("fs");
var TestRPC = require("ganache-cli");
var Resolver = require("ontsc-resolver");
...
describe("migrate", function() {
  ...
  it("should ignore files that don't start with a number", function(done) {
    fs.writeFileSync(path.join(config.migrations_directory, "~2_deploy_contracts.js"), "export = function() {};", "utf8");
